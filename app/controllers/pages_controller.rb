class PagesController < ApplicationController
  ...
  def export
    ...
    web.each do |page|
      ...
      File.open("#{Rails.root}/app/public/output/#{web_page.name}.html", 'w+') do |f|
        f.write(web_page)
      end
      input_filenames << "#{web_page.name}.html"
    end
    folder = "#{Rails.root}/app/public/output"
    zipfile_name = "#{Rails.root}/app/public/output/archive.zip"
