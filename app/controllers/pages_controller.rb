class PagesController < ApplicationController
  ...
  def export
    ...
    web.each do |page|
      ...
      File.open("#{Rails.root}/app/assets/output/#{web_page.name}.html", 'w+') do |f|
        f.write(web_page)
      end
      input_filenames << "#{web_page.name}.html"
    end
    folder = "#{Rails.root}/app/assets/output"
    zipfile_name = "#{Rails.root}/app/assets/output/archive.zip"
